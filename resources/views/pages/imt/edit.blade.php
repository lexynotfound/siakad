    ...
    <div class="main-content">
        <section class="section">
            <div class="section-header">
                <h1>Form Change IMT</h1>
                <div class="section-header-breadcrumb">
                    <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
                    <div class="breadcrumb-item"><a href="{{route('imt.index')}}">IMT</a></div>
                    <div class="breadcrumb-item">Edit IMT</div>
                </div>
            </div>

            <div class="section-body">
                <h2 class="section-title">Edit Detail IMT</h2>
                ...
                <div class="row">
                    <div class="col-12 col-md-6 col-lg-12">
                        <div class="card">
                            <form action="{{route('imt.update', $imt)}}" method="post">
                                @csrf
                                @method('put')
                                <div class="card-header">
                                    <h4>Edit Detail IMT</h4>
                                </div>
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            is-invalid
                                            @enderror"
                                            required="" name="nama" value="{{$imt->nama}}">
                                            @error('nama')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            is-invalid
                                            @enderror"
                                            required="" name="phone" id="phoneInput" value="{{$imt->phone}}">
                                            @error('phone')
                                            <div class="invalid-feedback">
                                                {{$message}}
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <label>Weight</label>
                                        <input type="text"
                                            class="form-control " name="berat_badan" value="{{$imt->berat_badan}}">
                                    </div>
                                    <div class="form-group">
                                        <label>Height</label>
                                        <input type="text"
                                            class="form-control " name="tinggi_badan" value="{{$imt->tinggi_badan}}">
                                    </div>
                                    <div class="form-group">
