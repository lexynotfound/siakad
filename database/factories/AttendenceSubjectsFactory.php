...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\AttendenceSubjects>
 */
class AttendenceSubjectsFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        return [
            ...
            'attendence_code' => $this->faker->randomElement(['A1','A2','A3','A4','A5','A6']),
